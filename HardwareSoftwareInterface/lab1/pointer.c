 ...
 *
 * <rashikoz@gmail.com Rashik Thalppully>
 *
...
int withinSameBlock(int * ptr1, int * ptr2) {
  ...
  long int mask64;
  mask64 = (~0x3f);  
  blockptr1 = ((long int)ptr1 & mask64);
  blockptr2 = ((long int)ptr2 & mask64);
  inBlock = !(blockptr1^blockptr2);
  return inBlock;
}
...
int withinArray(int * intArray, int size, int * ptr) {
  ...
  long int mask;
  int sizOfInt;
  sizOfInt = ((char *)(intArray+1) - (char *)(intArray));
  mask = (~(size*sizOfInt - 1)); 
  ptrBlock = ((long int)ptr & mask);
  arrayBlock = ((long int)intArray & mask);
  inArray = !(ptrBlock^arrayBlock);
  return inArray;
}
/*
